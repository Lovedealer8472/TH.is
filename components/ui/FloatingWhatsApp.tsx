...
export default function FloatingWhatsApp() {
  ...
  const whatsappUrl = `https://wa.me/${whatsappNumber}?text=Hæ%2C%20ég%20vildi%20spyrja%20um%20tölvuþjónustu`;
  ...
  return (
    <a
      ...
      aria-label="Hafðu samband á WhatsApp"
      title="Hafðu samband á WhatsApp"
    >
