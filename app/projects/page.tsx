...
const allProjects = [
  {
    ...
    desc: 'Létt kanban-pöntunarborð fyrir búðir sem taka við sérpöntunum eða viðgerðum. Sameiginlegt borð fyrir alla starfsmenn. Viðskiptavinur flettir upp stöðu með símanúmeri. Sjálfvirkur póstur þegar varan er Komin. Hýst, uppfært og backed up af okkur — opnast í vafra, ekkert að setja upp.',
  ...
  },
  {
    ...
    desc: 'Talgervill þjálfaður af íslenskum raddleikurum í samstarfi við RÚV og HR. Breyttu íslensku texta í talað mál með 30+ röddum, einföldu REST API og snjallri textavinnslu sem meðhöndlar tölur, skammstafanir og fleira.\n\nVerkið er enn í vinnslu en lofar góðu.',
  ...
  },
  {
    ...
    desc: 'Android app sem hjálpar fólki að finna tjaldsvæði og bílastæði á Íslandi. Notar Google Maps SDK, virkar offline, og ber virðingu fyrir persónuvernd — engin gagnasöfnun, engin auglýsing, ekkert bakendi. Campybara Pro í boði með Google Play Billing.',
    features: ['Google Maps SDK', 'Offline virkni', 'Google Play Billing', 'Persónuvernd í fyrirrúmi'],
    cta: 'Sækja APK',
    href: 'https://www.tolvuhvislarinn.is/downloads/Campybara-1.0.6-demo.apk',
    external: true,
  },
  {
    tag: 'Vafraleikur',
