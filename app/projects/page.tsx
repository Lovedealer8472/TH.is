...
const allProjects = [
  ...
  },
  {
    ...
    desc: 'Talgervill þjálfaður frá grunni á opnum íslenskum talgögnum úr máltækniáætlun stjórnvalda. Átta raddir, einfalt REST API og snjöll textavinnsla sem les tölur og skammstafanir sjálfkrafa. Öll vinnsla fer fram á Íslandi og enginn texti er vistaður.\n\nOpin prufuútgáfa — prófaðu í vafranum.',
    features: ['8 íslenskar raddir', 'Prófaðu í vafranum', 'Einfalt REST API', 'Enginn texti vistaður'],
    cta: 'Prófa talgervilinn',
    href: '/tts.html',
    external: true,
  },
  {
