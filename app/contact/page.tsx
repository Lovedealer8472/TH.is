    ...
    <div className="py-16 sm:py-24">
      <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="mb-16 text-center">
          ...
          <p className="text-xl text-warm-200 mb-12 leading-relaxed max-w-3xl mx-auto">
            {t.contact.intro}
          </p>

          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-12 max-w-4xl mx-auto">
            <div className="bg-warm-800/50 backdrop-blur-sm rounded-xl border border-warm-700/50 p-6 hover:border-primary-500/50 transition-all duration-300">
              ...
              <h3 className="text-sm font-semibold text-warm-200 mb-2">{t.contact.phone}</h3>
              <p className="text-lg text-warm-50">
            ...
            <div className="bg-warm-800/50 backdrop-blur-sm rounded-xl border border-warm-700/50 p-6 hover:border-primary-500/50 transition-all duration-300">
              ...
              <h3 className="text-sm font-semibold text-warm-200 mb-2">{t.contact.email}</h3>
              <p className="text-lg text-warm-50">
          ...
          <div className="mb-16">
            <p className="text-base text-warm-200 mb-4">Eða hafðu samband í gegnum:</p>
